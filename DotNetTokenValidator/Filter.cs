...
{
    public class Filter : IClientMessageInspector, IDispatchMessageInspector
    {
        ...
        public Filter(XmlSchemaSet schemaSet, bool validateRequest, bool validateReply, bool isClientSide)
        {
